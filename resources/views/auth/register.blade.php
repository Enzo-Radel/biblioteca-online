<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <label class="group flex items-center cursor-pointer">
            <input class="hidden peer" type="checkbox" name="isAdmin"/>
            ...
            <span
            class="ml-2 text-sm text-gray-700 group-hover:text-blue-500 font-medium transition-colors duration-300"
            >
